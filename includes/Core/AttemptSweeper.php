...
class AttemptSweeper {
    ...
    private function sweep_v2(): int {
        ...
        // Close any in-progress attempt whose exam has ended. The window is the
        // EARLIER of the official exam window (scheduled_at + duration_seconds)
        // and the student's personal timer (started_at + duration_seconds +
        // extension_seconds). This ensures a student who started late is still
        // closed when the exam officially ends.
