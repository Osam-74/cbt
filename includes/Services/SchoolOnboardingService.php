...
class SchoolOnboardingService {
    ...
    public function create_school( array $data ): array {
        ...
        $inserted = $wpdb->insert(
            ...
            [
                ...
                'principal_photo' => esc_url_raw( (string) ( $data['principal_photo'] ?? '' ) ),
            ],
            [ '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s' ]
        );
    ...
    public function update_school( int $school_id, array $data ): bool {
        ...
        if ( isset( $data['principal_photo'] ) && trim( (string) $data['principal_photo'] ) !== '' ) {
            $allowed['principal_photo'] = esc_url_raw( (string) $data['principal_photo'] );
        }
