        ...
        <form method="post" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>" class="educbt-form" enctype="multipart/form-data">
            ...
            <div class="educbt-grid">
                ...
                <div>
                    ...
                    <input id="logo_file" name="logo_file" type="file" accept="image/*" onchange="educbtPreviewLogo(this)">
                    <input id="logo" name="logo" type="hidden" value="<?php echo esc_attr( (string) ( $school['logo'] ?? '' ) ); ?>">
                </div>
            ...
            <div id="logo-preview-wrap" style="margin-top:12px<?php echo empty( $school['logo'] ) ? ';display:none' : ''; ?>">
                <img id="logo-preview-img" src="<?php echo esc_url( (string) ( $school['logo'] ?? '' ) ); ?>" alt="" style="max-width:110px;border:1px solid var(--edu-line);border-radius:8px;padding:6px;background:#fff">
            </div>
            <script>
            function educbtPreviewLogo(input) {
