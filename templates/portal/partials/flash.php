...
<div class="educbt-card educbt-card--live">
    ...
    <?php elseif ( $type === 'questions_reviewed' ) : ?>
        <h2><?php echo esc_html( (string) $result['decision'] === 'approved' ? 'Questions approved' : 'Questions sent back' ); ?></h2>
        <p><?php echo esc_html( sprintf( '%d question(s) updated. The teacher has been notified.', (int) $result['changed'] ) ); ?></p>
