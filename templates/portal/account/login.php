...
<main class="educbt-signin__wrap">
    <div class="educbt-signin__card">
        ...
        <?php // Every school signs in through this same page, and the site name
              // means nothing to a parent or a student. A plain greeting works for
              // all of them; the crest above already identifies the school. ?>
        <h1>Welcome</h1>
