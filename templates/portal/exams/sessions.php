...
$type_f   = isset( $_GET['type'] ) ? sanitize_text_field( wp_unslash( $_GET['type'] ) ) : '';
...
$educbt_body = static function () use (
    ...
    $events, $expanded_id,
    $search, $subject, $status, $class_f, $session_f, $term_f, $type_f, $reset, $can_view_all, $area
): void {
    ?>
    ...
    <section class="educbt-card">
        <form method="get" action="" class="educbt-filters">
            ...
            <div class="educbt-field">
                ...
                <select name="type">
                    <option value="">All</option>
                    <option value="test" <?php selected( $type_f, 'test' ); ?>>CA Tests</option>
                    <option value="exam" <?php selected( $type_f, 'exam' ); ?>>Examinations</option>
                </select>
            </div>
            <div class="educbt-field">
                <label>Class</label>
                <select name="class">
                    ...
                    <?php foreach ( $all_classes as $cl ): ?>
                        <option value="<?php echo esc_attr( $cl['id'] ); ?>" <?php selected( $class_f, (int) $cl['id'] ); ?>><?php echo esc_html( educbt_class_level_name( (string) $cl['display_name'] ) ); ?></option>
                    <?php endforeach; ?>
                </select>
            </div>
            <?php if ( $can_view_all ): ?>
        ...
        <table class="educbt-table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?php echo esc_html( $row['class_name'] ? educbt_class_level_name( (string) $row['class_name'] ) : '—' ); ?></td>
