    ...
    <section class="educbt-card">
        ...
        <?php if ( empty( $upcoming ) ) : ?>
            ...
            <?php if ( $educbt['scope']->is_school_wide() ) : ?>
                <p class="educbt-muted">Add questions to the bank, then schedule a paper.</p>
                <p><a class="educbt-btn educbt-btn--primary" href="<?php echo esc_url( home_url( '/portal/exams/papers/' ) ); ?>">Schedule a paper</a></p>
            <?php else : ?>
